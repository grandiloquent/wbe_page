function initializeSearchBar() {
    document.body.insertAdjacentHTML('afterbegin', `<div class="topbar-renderer">
        <div class="topbar-header">
            <button class="home-logo">
                <div class="c3-icon" style="width: 93px;height: 20px;">
                    <svg xmlns="http://www.w3.org/2000/svg" id="yt-ringo2-svg_yt1" width="93" height="20"
            ...
            <div class="topbar-back-arrow" style="display: none;">
                <div class="c3-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" divBox="0 0 24 24"
                        width="24" focusable="false" aria-hidden="true"
                        style="pointer-events: none; display: inherit; width: 100%; height: 100%;">
                        <path clip-rule="evenodd"
            ...
            <div class="searchbox" style="display: none;">
                <div class="input-box">
                    <div class="form">
                        ...
                        <input class="search-query" name="search-query" type="text" autocomplete="off" autocorrect="off"
                            placeholder="在 视频 中搜索">
                    </div>
                    <div class="clear-button-wrapper">
                        <div class="clear-button">
                            <div class="c3-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24"
                                    divBox="0 0 24 24" width="24" focusable="false" aria-hidden="true"
                                    style="pointer-events: none; display: inherit; width: 100%; height: 100%;">
                                    <path
